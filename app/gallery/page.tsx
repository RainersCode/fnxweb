          ...
          <div className="container mx-auto px-4 sm:px-6 relative z-10">
            <div className="max-w-3xl mx-auto text-center text-white">
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tighter mb-4">
                ...
                <span className="text-white font-light italic ml-2">GALLERY</span>
              </h1>
              <div className="h-1 w-32 bg-white mx-auto mb-6 transform skew-x-[-12deg]"></div>
              <p className="text-xl text-teal-100">
                Capturing the moments that define our club, from match day action to community events.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              {categories.map((category) => (
                ...
                >
                  <span className="transform skew-x-[12deg] inline-flex items-center">{category.name}</span>
                </button>
              ))}
            </div>
              ...
              {filteredImages.map((image) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-teal-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                    ...
                    <p className="text-teal-100 text-sm">{image.description}</p>
                  </div>
                </div>
              ))}
            </div>
